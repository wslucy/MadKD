...
from models.util import ConvReg, SelfA, SRRL, SimKD, MadKD
...
from distiller_zoo import DistillKL, HintLoss, Attention, Similarity, VIDLoss, SemCKDLoss, DKDLoss, MadKDLoss
...
def main_worker(gpu, ngpus_per_node, opt):
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        # opt.rev_factor = gradient_decay.get_value(epoch)
        print("==> training...")
